...
pub(crate) const KNOWN_EXTENSIONS: &[(u32, &str, &str)] = &[
    ...
    (0x03E4_21EC, "grey8", "Terrain Field Map (8-bit)"),
    (0x03E4_21ED, "grey32", "Terrain Field Map (32-bit)"),
    (0x03E4_21F0, "grey16", "Terrain Heightmap (16-bit)"),
    (0x0806_8AED, "ecogame-state", "EcoGame State Data (gzip)"),
    (0x0806_8AEE, "ecogame-table", "EcoGame State Table"),
