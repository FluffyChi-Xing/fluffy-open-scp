...
const nodes: FTreeNode[] = [
    ...
    children: [
      {
        ...
        icon: "FolderOpen",
        children: [
          { key: "main", label: "main.ts", icon: "FileText" },
          { key: "pages", label: "pages", icon: "FolderOpen" },
        ],
      },
  ...
  },
  {
    ...
    icon: "FolderOpen",
    children: [
      { key: "content-read", label: "content:read", icon: "FileText" },
      { key: "content-write", label: "content:write", icon: "FileText" },
    ],
  },
];
...
<template>
  <section class="page">
    <header>
      ...
      <h1>Tree</h1>
      <p>用于文件夹、CMS 结构和权限 token 的层级选择。</p>
    </header>
    <article class="panel">
      <FTree
        :data="nodes"
